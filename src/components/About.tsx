        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-medium mb-6 leading-tight">
              We Build Brands That <span className="text-gradient-gold">Outperform</span>
            </h2>
            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="p-8 bg-card border border-border rounded-lg text-center hover:border-gold/30 transition-colors duration-300"
                >

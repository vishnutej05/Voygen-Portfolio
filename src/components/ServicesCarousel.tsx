...
const servicePackages = [
  ...
  },
  {
    ...
    description: "Stunning, high-performance websites that convert visitors into loyal customers and drive business growth.",
    features: ["Custom Website", "UI/UX Design", "Responsive Design", "CMS Integration"],
  },
  {
    id: "growth-marketing",
    icon: TrendingUp,
    ...
    description: "Data-driven marketing strategies that deliver measurable results and maximize your return on investment.",
    features: ["SEO Optimization", "Google Ads", "Analytics", "Conversion Rate"],
  },
  {
    id: "social-mastery",
    icon: Users,

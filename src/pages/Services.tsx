...
const allServices = [
  ...
  },
  {
    ...
    description: "Your website is your business's digital home. A well-built website builds credibility, answers questions, captures leads, and converts visitors into customers. Starting from ₹2999*.",
    features: [
  ...
  },
  {
    ...
    subtitle: "Reach & Grow",
    description: "Digital marketing is not just about being present online — it's about being noticed, remembered, and trusted. We use automation and AI to make marketing faster, more affordable, and more precise.",
    features: [
